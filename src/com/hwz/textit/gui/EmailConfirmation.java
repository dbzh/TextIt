...
public class EmailConfirmation {
	...
	public EmailConfirmation(String receiver, String receiverCC,
			String receiverBCC, String message, String prio, String type,
			String fileName) {
		createAndShowEmailConfirmation(receiver, receiverCC, receiverBCC,
				message, prio, type, fileName);
	}

	private void createAndShowEmailConfirmation(String receiver,
			String receiverCC, String receiverBCC, String message, String prio,
		...
		buildConfirmationPanel(frame, receiver, receiverCC, receiverBCC,
				message, prio, type, fileName);
	...
	private void buildConfirmationPanel(JFrame frame, String receiver,
		...
		confirmationMessage.setBounds(10, 180, 400, 100);
		confirmationFileName.setBounds(10, 200, 400, 25);
